 ...
 * @author Dimitar
 * 
 * A class that handles the GERBIL requests and transforms them in the required format.
 *
 */
public class DoserResource extends ServerResource {

	public static final String DISAMBIGUATIONSERVICE = "http://paxos.informatik.uni-freiburg.de:8080/WELT/disambiguationWithoutCategories-collective";
...
//							document.getText()));
		...
		//				document.getText());
				...
				dpo.setSelectedText(sf.toLowerCase());
