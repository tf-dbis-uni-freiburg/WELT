...
class LocationDisambiguation {
	...
	public LocationDisambiguation(EntityCentricKBWikidata eckb) {
		super();
		this.eckb = eckb;
	}
	...
	private void disambiguate(SurfaceForm c) {
		String context = AbstractDisambiguationAlgorithm.extractContext(
				...
				CollectiveAndContextDriverWikidata.PREPROCESSINGCONTEXTSIZE);
