package welt.entitydisambiguation.properties;
...
//	private static final String RESOURCE_NAME = "./disambiguation.properties";
	 ...
	 * Get location of entity-centric knowledge base
	 */
	public String getEntityCentricKBWikidata() {
		return this.config.getString("disambiguation.entityCentricKBWikidata");
	}
